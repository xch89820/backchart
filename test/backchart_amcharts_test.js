...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        /** dist*/
        define(['jquery','backamcharts',"AmCharts.theme.light",'AmCharts.language.zh-CN'], function($, base) {
            require(["backchart.amcharts"], function(chart){
                factory($, chart.model, chart.collection, chart.view);
            });
        });
        /** debug*/
        /*define(['jquery','backchart.amcharts',"AmCharts.theme.light",'AmCharts.language.zh-CN'], function($, chart) {
          factory($, chart.model, chart.collection, chart.view);
          });*/
    }else{
        factory($,
